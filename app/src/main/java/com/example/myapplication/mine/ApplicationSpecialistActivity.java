...
public class ApplicationSpecialistActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                switch (message.what) {
                    case 0:
                        ...
                        try {
                            ...
                            //展示选择的图片
                            Bitmap bitmap = MediaStore.Images.Media.getBitmap(ApplicationSpecialistActivity.this.getContentResolver(), uri);
